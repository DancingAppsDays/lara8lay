...
class CreateExamenmesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('examenmes', function (Blueprint $table) {
            ...
            $table->text('fechaingreso')->nullable();
            $table->text('area')->nullable();
            $table->text('cc')->nullable();
            $table->text('numnomina')->nullable();
            $table->text('puestoac')->nullable();
            $table->text('tiempospues')->nullable();        //is date till now
            $table->text('puestoacdesc')->nullable();


            $table->text('ruidobox')->nullable();
            $table->text('vibrabox')->nullable();
            ...
            $table->text('manejodecargasanterior')->nullable();
            $table->text('manejodecargasanteriord')->nullable();
            ...
            $table->text('enfemasangre')->nullable();
            $table->text('enfemasangred')->nullable();
            ...
            $table->text('opresionpecho')->nullable();
