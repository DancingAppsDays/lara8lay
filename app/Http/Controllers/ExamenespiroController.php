...
use App\Models\examenespiro as ex;


class ExamenespiroController extends Controller
{
    public function store(Request $request)
    {
        ...
        return response()->json([
          'status' => 'success',
          'mensaje' => 'Examen espiro añadido con èxito',
          'data' => $ex
          ]);
    ...
    public function show($id) //for individual resource
    {
        ...
        return response()->json([
            'status' => 'success',
            'mensaje' => 'Examen espiro recuperada con éxito',
            'data' => $article
        ]);
        //return   $article;
    }
    ...
    public function showall($id) //for individual resource
    {
        ...
        return response()->json([
            'status' => 'success',
            'mensaje' => 'Examenes espiro obtenido con èxito',
            'data' => $article
        ]);
