...
use App\Models\examensangre as ex;


class ExamensangreController extends Controller
{
    public function store(Request $request)
    {
        ...
        return response()->json([
          'status' => 'success',
          'mensaje' => 'Laboratorio sangre añadido con èxito',
          'data' => $ex
          ]);
    ...
    public function show($id) //for individual resource
    {
        ...
        return response()->json([
            'status' => 'success',
            'mensaje' => 'Laboratorio sangre recuperada con éxito',
            'data' => $article
        ]);
        //return   $article;
    }
    ...
    public function showall($id) //for individual resource
    {
        ...
        return response()->json([
            'status' => 'success',
            'mensaje' => 'Examenes Laboratorio sangre obtenido con èxito',
            'data' => $article
        ]);
